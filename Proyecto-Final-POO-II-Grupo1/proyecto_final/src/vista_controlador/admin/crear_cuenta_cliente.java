...
public class crear_cuenta_cliente extends javax.swing.JFrame {

    usuario_Array usuario_a = new usuario_Array();
    Auxiliares aux = new Auxiliares();
    cliente_Array cliente_a = new cliente_Array();

    public crear_cuenta_cliente() {
        initComponents();
    ...
    private void initComponents() {
        ...
        getContentPane().add(password2_, new org.netbeans.lib.awtextra.AbsoluteConstraints(420, 400, 140, -1));
        ...
        getContentPane().add(credencial_, new org.netbeans.lib.awtextra.AbsoluteConstraints(420, 260, 140, -1));
        ...
        getContentPane().add(jLabel7, new org.netbeans.lib.awtextra.AbsoluteConstraints(130, 400, 250, 30));
        ...
        getContentPane().add(jLabel6, new org.netbeans.lib.awtextra.AbsoluteConstraints(330, 460, 50, 30));

        sexo_.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "", "Masculino", "Femenino", "Otros" }));
        getContentPane().add(sexo_, new org.netbeans.lib.awtextra.AbsoluteConstraints(420, 460, 140, -1));

        password_.setFont(new java.awt.Font("Dialog", 0, 18)); // NOI18N
        getContentPane().add(password_, new org.netbeans.lib.awtextra.AbsoluteConstraints(420, 330, 140, -1));
        ...
        getContentPane().add(nombre_, new org.netbeans.lib.awtextra.AbsoluteConstraints(420, 130, 140, -1));
        ...
        getContentPane().add(apellido_, new org.netbeans.lib.awtextra.AbsoluteConstraints(420, 190, 140, -1));
    ...
    public static void main(String args[]) {
        try {
            ...
            java.util.logging.Logger.getLogger(crear_cuenta_cliente.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new crear_cuenta_cliente().setVisible(true);
            }
        });
    }
