...
public class cliente_buscar_comprobante extends javax.swing.JFrame {

    productos_Array array1 = new productos_Array();
    Auxiliares aux = new Auxiliares();

    public cliente_buscar_comprobante() {
        initComponents();
        array1.inicializar();
    }
    ...
    private void b_buscarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_b_buscarActionPerformed
        ...
        if (codigo > array1.rows()) {
            ...
            precio.setText("");
            precio_.setText("");
            JOptionPane.showMessageDialog(rootPane, "Codigo no encontrado", "Error de búsqueda", JOptionPane.ERROR_MESSAGE);
        } else {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(cliente_buscar_comprobante.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new cliente_buscar_comprobante().setVisible(true);
            }
        });
    }
