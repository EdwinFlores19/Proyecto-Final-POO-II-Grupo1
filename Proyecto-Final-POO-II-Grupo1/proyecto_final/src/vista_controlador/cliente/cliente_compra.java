...
public class cliente_compra extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        getContentPane().add(codigo_, new org.netbeans.lib.awtextra.AbsoluteConstraints(60, 290, 150, -1));
        ...
        b_buscar.setText("seleccionar");
        b_buscar.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                b_buscarActionPerformed(evt);
            }
        });
        getContentPane().add(b_buscar, new org.netbeans.lib.awtextra.AbsoluteConstraints(50, 330, 170, -1));
