...
public class admin_ventas_view extends javax.swing.JFrame {

    Auxiliares aux = new Auxiliares();

    public admin_ventas_view() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        try {
            ...
            java.util.logging.Logger.getLogger(admin_ventas_view.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new admin_ventas_view().setVisible(true);
            }
        });
    }
