...
public class admin_listar_cuentas extends javax.swing.JFrame {
    ...
    public static void main(String args[]) {
        try {
            ...
            java.util.logging.Logger.getLogger(admin_listar_cuentas.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new admin_listar_cuentas().setVisible(true);
            }
        });
    }
